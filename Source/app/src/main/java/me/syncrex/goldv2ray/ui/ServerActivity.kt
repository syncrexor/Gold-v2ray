...
import me.syncrex.goldv2ray.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import me.syncrex.goldv2ray.AppConfig.WIREGUARD_LOCAL_MTU
import me.syncrex.goldv2ray.R
import me.syncrex.goldv2ray.AppConfig.DEFAULT_PORT
import me.syncrex.goldv2ray.AppConfig.REALITY
import me.syncrex.goldv2ray.AppConfig.TLS
...
class ServerActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //title = getString(R.string.title_server) //GOLDV2RAY
        //GOLDV2RAY
        val pageTitle = intent.getStringExtra("pageTitle") ?: getString(R.string.title_server)
        supportActionBar?.let { actionBar ->
            val title = SpannableString(pageTitle)

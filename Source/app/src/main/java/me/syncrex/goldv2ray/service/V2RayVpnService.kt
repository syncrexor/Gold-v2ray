...
import me.syncrex.goldv2ray.AppConfig.VPN_MTU
import me.syncrex.goldv2ray.BuildConfig
import me.syncrex.goldv2ray.handler.MmkvManager
import me.syncrex.goldv2ray.handler.NotificationManager
...
//    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        NotificationManager.showNotification(currentConfig = null) //GOLDV2RAY
...
//        saveVpnNetworkInfo(configName, info)
    ...
    private fun pauseV2Ray() {
        ...
        V2RayServiceManager.stopCoreLoop(cancelNotification = false, unregisterReceiver = false)

        if (::mInterface.isInitialized) {
            try { mInterface.close() } catch (_: Exception) {}
        }

        NotificationManager.showPausedNotification(V2RayServiceManager.getRunningServerName())
    }

    private fun resumeV2Ray() {
        NotificationManager.showRunningNotification(V2RayServiceManager.getRunningServerName())

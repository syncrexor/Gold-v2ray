...
import me.syncrex.goldv2ray.databinding.ActivityUserAssetUrlBinding
...
class UserAssetUrlActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //title = getString(R.string.title_user_asset_add_url) //GOLDV2RAY
        //GOLDV2RAY
        supportActionBar?.let { actionBar ->
            val title = SpannableString(getString(R.string.title_user_asset_add_url))

...
object AppConfig {
    ...
    const val BROADCAST_ACTION_SERVICE = "me.syncrex.goldv2ray.action.service" //GOLDV2RAY
    const val BROADCAST_ACTION_ACTIVITY = "me.syncrex.goldv2ray.action.activity" //GOLDV2RAY
    const val BROADCAST_ACTION_WIDGET_CLICK = "me.syncrex.goldv2ray.action.widget.click" //GOLDV2RAY
    ...
    var ADS_INTERSTITIAL_SHOW_ON_TIME = 10
    var ADS_NATIVE_STATUS = true
    var ADS_SERVICE = "ADMOB"
    const val PIN_CODE_LENGTH = 5
    var LOCK_PROFILES = false
    var STORE_MODE = false
    var NUMBER_OF_ALL_SERVERS = 0
    var NUMBER_OF_PASSED_SERVERS = 0
    var NUMBER_OF_OK_SERVERS = 0
    var NUMBER_OF_FAILURE_SERVERS = 0

    const val ADMOB_ID_BANNER = "ca-app-pub-3940256099942544/9214589741" //Test
    const val ADMOB_ID_INTERSTITIAL = "ca-app-pub-3940256099942544/1033173712" //Test
    const val ADMOB_ID_Native = "ca-app-pub-3940256099942544/2247696110" //Test

    const val SMART_MARKER = "__SMT__"
    const val MSG_STATE_PAUSE = 666
    const val MSG_STATE_RESUME = 999
}
...
import me.syncrex.goldv2ray.extension.toLongEx
import me.syncrex.goldv2ray.handler.SubscriptionUpdater
import me.syncrex.goldv2ray.handler.MmkvManager
import me.syncrex.goldv2ray.util.Utils
import me.syncrex.goldv2ray.viewmodel.SettingsViewModel
...
class SettingsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.let { actionBar ->
            val title = SpannableString(getString(R.string.title_settings))
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        //private val perAppProxy by lazy { findPreference<CheckBoxPreference>(AppConfig.PREF_PER_APP_PROXY) } //GOLDV2RAY
        ...
        override fun onCreatePreferences(bundle: Bundle?, s: String?) {
            ...
            autoUpdateInterval?.setOnPreferenceChangeListener { _, any ->
                ...
                nval =
                    //if (TextUtils.isEmpty(nval) || !nval.matches("\\d+".toRegex()) || nval.toLong() < 15) AppConfig.SUBSCRIPTION_DEFAULT_UPDATE_INTERVAL else nval
        ...
        override fun onStart() {
            ...
            autoUpdateInterval?.summary = MmkvManager.decodeSettingsString(AppConfig.SUBSCRIPTION_AUTO_UPDATE_INTERVAL,AppConfig.SUBSCRIPTION_DEFAULT_UPDATE_INTERVAL)
        ...
        private fun updateMode(mode: String?) {
            val vpn = mode == VPN
            //perAppProxy?.isEnabled = vpn //GOLDV2RAY
            //perAppProxy?.isChecked = MmkvManager.decodeSettingsBool(AppConfig.PREF_PER_APP_PROXY, false) //GOLDV2RAY

...
object AppConfig {
    ...
    const val BROADCAST_ACTION_SERVICE = "me.syncrex.goldv2ray.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "me.syncrex.goldv2ray.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "me.syncrex.goldv2ray.action.widget.click"
    ...
    const val goldV2rayIssues = "https://github.com/2dust/v2rayNG/issues"
    ...
    // gold v2ray
    const val FEEDBACK_MAIL = "dev@syncrex.me"
    const val GOOGLEPLAY_URL = "https://play.google.com/store/apps/dev?id=9173889272945325145"
    const val GOLDV2RAY_PRIVACYPOLICY = "https://syncrex.me/policy/gold_v2ray/"
    var ADS_BANNER_STATUS = true
    var ADS_BANNER_TIMER_HOUR = 3
    var ADS_BANNER_TIMER_MINUTE = 0
    var ADS_INTERSTITIAL_STATUS = true
    var ADS_INTERSTITIAL_SHOW_ON_TIME = 20
    var ADS_SERVICE = "ADMOB"
    //var ADS_SERVICE = "ADIVERY"
    //var ADS_SERVICE = "TAPSELL"
    const val ADMOB_ID_BANNER = "REPLACE_ME"
    const val ADMOB_ID_INTERSTITIAL = "REPLACE_ME"
    var ADIVERY_ID_APP = "REPLACE_ME"
    var ADIVERY_ID_BANNER = "REPLACE_ME"
    var ADIVERY_ID_INTERSTITIAL = "REPLACE_ME"
    var TAPSELL_ID_APP = "REPLACE_ME"
    var TAPSELL_ID_BANNER = "REPLACE_ME"
    var TAPSELL_ID_INTERSTITIAL = "REPLACE_ME"
    const val PIN_CODE_LENGHT = 5
    const val ENCRYPTION_SECRET_KEY = "REPLACE_ME"
    var LOCK_PROFILES = false
    var STORE_MODE = false
    var FREE_SERVERS_A = "REPLACE_ME"
    var FREE_SERVERS_B = "REPLACE_ME"
    var FREE_SERVERS_C = "REPLACE_ME"
}

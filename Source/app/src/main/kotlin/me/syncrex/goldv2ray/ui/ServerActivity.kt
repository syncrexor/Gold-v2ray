...
import me.syncrex.goldv2ray.dto.ServerConfig
import me.syncrex.goldv2ray.dto.V2rayConfig
import me.syncrex.goldv2ray.dto.V2rayConfig.Companion.DEFAULT_PORT
import me.syncrex.goldv2ray.dto.V2rayConfig.Companion.TLS
import me.syncrex.goldv2ray.extension.toast
import me.syncrex.goldv2ray.util.MmkvManager
import me.syncrex.goldv2ray.util.MmkvManager.ID_MAIN
import me.syncrex.goldv2ray.util.MmkvManager.KEY_SELECTED_SERVER
...
class ServerActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = (Html.fromHtml("<font color=\"#FFC107\">" + getString(R.string.title_server) + "</font>"))

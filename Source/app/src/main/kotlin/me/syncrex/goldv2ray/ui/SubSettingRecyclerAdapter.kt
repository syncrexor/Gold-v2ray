...
import me.syncrex.goldv2ray.databinding.ItemRecyclerSubSettingBinding
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        if (TextUtils.isEmpty(subItem.url)) {
            ...
            holder.itemSubSettingBinding.layoutShare.setOnClickListener {
                AlertDialog.Builder(mActivity, R.style.DialogStyle)
                        ...
                        try {
                            when (i) {
                                0 -> {
                                    ...
                                    AlertDialog.Builder(mActivity, R.style.DialogStyle).setView(ivBinding.root).show()
                                }
